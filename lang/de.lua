...
L.Settings_General_Choices_Small                    = "Klein (veraltet)"
L.Settings_General_Choices_Large                    = "Groß (veraltet)"
L.Settings_General_Choices_Major                    = "Normal (veraltet)"
...
L.Settings_Ultimate_OverrideCost_TT                  = "Verwendt diesen Wert, wenn deine Ulti Kosten an andere gesendt werden. Wird der Wert auf 0 gesetzt, wird das Überschreiben deaktiviert."
...
L.Settings_Cloudrest_Baneful_Barb_TT            = "Warnt dich, wenn Yaghra Monstrosität dich als Ziel gewählt hat und mit Unheilvolle Dornen angreift, welchen ausgewichen werden muss."
...
L.Settings_Sunspire_Frozen_Tomb_TT        = "Warnt dich, wenn ein Gefrorenes Grab erscheint. Ein Spieler muss in das Grab gehen, was ihn einfriert und ihm mit der Zeit Schaden zufügt. Dieser muss dann geheilt werden, um freigelassen zu werden. Benötigt 3 Spieler aufgrund eines Debuffs, jedes Mal eine andere Person."
L.Settings_Sunspire_Thrash                = "Nahviintaas: Dreschen"
L.Settings_Sunspire_Thrash_TT             = "Warnt dich, wenn der Boss dabei ist, seinen Kopf durch die Gruppe zu schwingen und alle zurück stößt(blocken oder ausweichen)."
...
L.Settings_Sunspire_Shock_Bolt_TT         = "Schockender Stoß Countdown, der die Gruppe informiert, wenn gestackt werden muss, um einen anderen Spieler zu entpinnen."
...
L.Alerts_Sunspire_Shock_Bolt              = "|c00ddffSchockender Stoß|r! Stack zum Entpinnen in"
L.Alerts_Sunspire_Apocalypse              = "|cffff00Verschiebungsapokalypse|r. Unterbrechen!"
